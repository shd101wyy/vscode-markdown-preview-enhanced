...
The extension pins crossnote 0.9.38; the user-visible changes of everything since the bundled 0.9.35 follow, grouped per crossnote release (the two 0.9.36 CLI mega-features are the engines behind the extension commands described above).
